...
if(empty($_GET)){
	...
	while($row = mysql_fetch_array($results))
	{
		...
		echo "<ul style='float:right;margin-left:20em;margin-top:-17em; list-style-type: none'><li><b style='color:#0000ff'>User Name:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b>".$row['user_name']."<li>";
