...
if(empty($_GET)){
	...
	while($row = mysql_fetch_array($results))
	{
		...
		echo "<div id='".$row['user_name']."' style='box-shadow: 1px 2px 2px 1px #888888;width:77em;background-color:#f0f0f0;margin-left:2em;height:30em;padding-right:20em;padding-top:2em'>";
		...
		echo "<tr><td colspan='2'><b style='color:#0000ff'>First Name:&nbsp&nbsp&nbsp&nbsp&nbsp</b></td><td>".$row['first_name']."</td></tr>";
		echo "<tr><td colspan='2'><b style='color:#0000ff'>Last Name:&nbsp&nbsp&nbsp&nbsp&nbsp</b></td><td>".$row['last_name']."</td></tr>";
		echo "<tr><td colspan='2'><b style='color:#0000ff'>Date of Birth:&nbsp&nbsp&nbsp&nbsp&nbsp</b></td><td>".$row['dob']."</td></tr>";
		echo "<tr><td colspan='2'><b style='color:#0000ff'>Sex:&nbsp&nbsp&nbsp&nbsp&nbsp</b></td><td>".$row['sex']."</td></tr>";
		echo "<tr><td colspan='2'><b style='color:#0000ff'>Date Of Joining:&nbsp&nbsp&nbsp&nbsp&nbsp</b></td><td>".$row['date_of_joining']."</td></tr>";
		echo "<tr><td colspan='2'><b style='color:#0000ff'>Address:&nbsp&nbsp&nbsp&nbsp&nbsp</b></td><td>".$row['address']."</td></tr>";
		echo "<tr><td colspan='2'><b style='color:#0000ff'>Salary:&nbsp&nbsp&nbsp&nbsp&nbsp</b></td><td>".$row['salary']."</td></tr>";
		echo "<tr><td colspan='2'><b style='color:#0000ff'>Employee Type:&nbsp&nbsp&nbsp&nbsp&nbsp</b></td><td>".$row['employee_type']."</td></tr>";
		echo "<tr><td colspan='2'><b style='color:#0000ff'>Phone No:&nbsp&nbsp&nbsp&nbsp&nbsp</b></td><td>".$row['phone_no']."</td></tr>";
		echo "<tr><td colspan='2'><b style='color:#0000ff'>Qualification:&nbsp&nbsp&nbsp&nbsp&nbsp</b></td><td>".$row['qualification']."</td></tr></table>";
