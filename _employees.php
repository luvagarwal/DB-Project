...
<?php
if($_SESSION['type']!='e')
   echo '<input type="text"class="form-control" onkeyup="search(this.value)" name="user_name" id="user_name" style="width:30em;margin-top:-2em;margin-left:2em;" placeholder="Search for a Employee....">';
else
  echo '<input type="text"class="form-control" onkeyup="search(this.value)" name="user_name" id="user_name" style="width:30em;margin-top:5em;margin-left:2em;" placeholder="Search for a Employee....">';
?>
